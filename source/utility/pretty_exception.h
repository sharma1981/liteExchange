...
#define EXCEPTION_CONSOLE_FOREGROUND_COLOR utility::ConsoleColor::FG_RED
#define EXCEPTION_MESSAGE_BOX_OUTPUT 0

#if EXCEPTION_CONSOLE_OUTPUT
#define OUTPUT_EXCEPTION_TO_CONSOLE(message) utility::consoleOutputWithColor(EXCEPTION_CONSOLE_FOREGROUND_COLOR, message)
#else
...
#define THROW_PRETTY_EXCEPTION(msg, exceptionType, exceptionTypeAsStringLiteral)  \
      do  {     \
                ...
                message += utility::getCallstackAsString(EXCEPTION_CALLSTACK_DEPTH); \
